...
result = llm.get_response(prompt, startup_info)

print(f"result of prompt2 is:{result}")

print("################the extracted json############")
print(extract_json_from_llm_response(result))



#result = llm.get_response("what is the meaning of life?", "what is the meaning of life?")
#print(result)
